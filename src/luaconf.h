...
** contract gas metering bounds that instead. (Since 5.5 the hook is a
** zero-argument function used by luaL_makeseed in lauxlib.c; embedders
** calling lua_newstate directly pass their own seed.)
*/
#if !defined(luai_makeseed)
#define luai_makeseed()		0x44494C55u  /* "DILU" */
#endif
